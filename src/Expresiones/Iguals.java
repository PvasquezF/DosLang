...
public class Iguals implements Expresion {
    ...
    public Iguals(Expresion cadena, Expresion cadena2, int fila, int columna) {
        this.cadena = cadena;
    ...
    public Object getTipo(Tabla tabla, Tree arbol) {
        ...
        if (tipo.getType() != Tipo.tipo.STRING) {
            Excepcion e = new Excepcion(Excepcion.TIPOERROR.SEMANTICO, "El parametro 1 de la funcion Equals necesita un string.",
        ...
        tipo = (Tipo) result;
        if (tipo.getType() != Tipo.tipo.STRING) {
            Excepcion e = new Excepcion(Excepcion.TIPOERROR.SEMANTICO, "El parametro 2 de la funcion Equals necesita un string.",
                    this.fila, this.columna);
            arbol.getErrores().add(e);
            return e;
        }
    ...
    public Object get4D(Tabla tabla, Tree arbol) {
        String codigo = "// Inicio llamada Equals fila: " + this.fila + ", columna: " + this.columna + "\n";
