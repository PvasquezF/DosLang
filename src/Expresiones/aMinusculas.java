...
public class aMinusculas implements Expresion {
    ...
    public aMinusculas(Expresion cadena, int fila, int columna) {
        this.cadena = cadena;
        this.fila = fila;
    ...
    public Object getTipo(Tabla tabla, Tree arbol) {
        ...
        if (tipo.getType() != Tipo.tipo.STRING) {
            Excepcion e = new Excepcion(Excepcion.TIPOERROR.SEMANTICO, "El parametro 1 de la funcion toLower necesita un string.",
    ...
    public Object get4D(Tabla tabla, Tree arbol) {
        String codigo = "// Inicio llamada toLower fila: " + this.fila + ", columna: " + this.columna + "\n";
        ...
        codigo += "call,,,toLowerPrimitiva\n";
        codigo += "+,p,0," + tabla.getTemporal() + "\n";
        codigo += "=,stack," + tabla.getTemporalActual() + "," + tabla.getTemporal() + "\n";
        codigo += "-,p," + tabla.getTamañoActualFuncion().peek() + ",p\n";
        codigo += "// Fin llamada toLower\n";
        return codigo;
    }
}